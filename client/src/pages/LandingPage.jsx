...
export default function LandingPage() {
  ...
  const features = [
    ...
    { icon: Timer, title: t('landing.eta') || 'Egyptian Tax Authority & E-Invoice', desc: t('landing.etaDesc') || 'Full compliance with the Egyptian Tax Authority (ETA) and the electronic invoicing system. Generate, send, and store e-invoices seamlessly.', color: 'bg-orange-600', gradient: 'bg-gradient-to-br from-orange-50 to-white dark:from-orange-900/10 dark:to-transparent' },
  ]
